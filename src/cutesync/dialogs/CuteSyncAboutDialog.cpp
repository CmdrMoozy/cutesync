 ...
 */
CuteSyncAboutDialog::CuteSyncAboutDialog(QWidget *p, Qt::WindowFlags f)
	: QDialog(p, f)
{
 ...
 */
CuteSyncAboutDialog::~CuteSyncAboutDialog()
{
}
 ...
 */
void CuteSyncAboutDialog::loadLicenseText()
{
