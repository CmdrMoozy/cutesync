 ...
 *
 * It is designed to provide both generic synchronization options as well as destination-specific
 * options.
 */
class CuteSyncSyncDialog : public QDialog
{
	...
	public:
		CuteSyncSyncDialog(CuteSyncCollectionModel *c, QWidget *p = 0, Qt::WindowFlags f = 0);
	...
	signals:
		void accepted();
		void accepted(CuteSyncAbstractCollection *, CuteSyncAbstractCollection *);
};
