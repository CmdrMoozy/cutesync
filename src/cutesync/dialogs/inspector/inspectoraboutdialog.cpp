...
#include "inspectoraboutdialog.h"
 ...
 */
CSInspectorAboutDialog::CSInspectorAboutDialog(QWidget *p, Qt::WindowFlags f)
	: QDialog(p, f)
{
 ...
 */
CSInspectorAboutDialog::~CSInspectorAboutDialog()
{
}

/*!
 * We hook onto our superclass's show event to reset the GUI state when the
 * dialog is displayed, making it reusable.
 *
 * \param e The event we are handling.
 */
void CSInspectorAboutDialog::showEvent(QShowEvent *e)
{
...
/*!
 * This function sets the about text we are supposed to be displaying,
 * presumably from a collection.
 *
 * \param t The text to display.
 */
void CSInspectorAboutDialog::setAboutText(const QString &t)
{
	aboutText->setText(t);
	aboutText->moveCursor(QTextCursor::Start);
}
