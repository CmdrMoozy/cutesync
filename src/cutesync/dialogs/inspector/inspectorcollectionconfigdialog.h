...
#ifndef INCLUDE_CUTE_SYNC_DIALOGS_INSPECTOR_INSPECTOR_COLLECTION_CONFIG_DIALOG_H
#define INCLUDE_CUTE_SYNC_DIALOGS_INSPECTOR_INSPECTOR_COLLECTION_CONFIG_DIALOG_H
 ...
 */
class CSInspectorCollectionConfigDialog : public QDialog
{
	Q_OBJECT
