 ...
 *
 * We can do either display columns or sort columns. These should be loaded into a DDSelectorModel and
 * then given to this class. We allow the user to enable/disable columns, and to change the order of
 * the columns via up/down buttons.
 */
