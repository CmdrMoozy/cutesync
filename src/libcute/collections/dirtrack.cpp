...
/*!
 * This constructor creates a new directory collection track from the given
 * file path. Note that this function doesn't automatically load track data;
 * rather, you should be sure to call refresh() before trying to access
 * attributes.
 *
 * \param p The path where the desired track file is located.
 */
CSDirTrack::CSDirTrack(const QString &p)
	: path(p)
{
}
 ...
 */
CSDirTrack::~CSDirTrack()
{
}

/*!
 * An attribute accessor function. This will return cached track information,
 * so it is quite fast. If you believe the track file may have changed,
 * rendering our cached data out-of-date, you should call refresh() before
 * accessing these attributes.
 *
 * \return The path to our track file.
 */
QString CSDirTrack::getPath() const
{
	return path;
}
 ...
 */
QString CSDirTrack::getTitle() const
{
	return title;
}
 ...
 */
QString CSDirTrack::getArtist() const
{
	return artist;
}
 ...
 */
QString CSDirTrack::getAlbum() const
{
	return album;
}
 ...
 */
QString CSDirTrack::getComment() const
{
	return comment;
}
 ...
 */
QString CSDirTrack::getGenre() const
{
	return genre;
}
 ...
 */
QString CSDirTrack::getAlbumArtist() const
{
	return albumartist;
}
 ...
 */
QString CSDirTrack::getComposer() const
{
	return composer;
}
 ...
 */
int CSDirTrack::getTrackNumber() const
{
	return trackNumber;
}
 ...
 */
int CSDirTrack::getTrackCount() const
{
	return trackCount;
}
 ...
 */
int CSDirTrack::getCDNumber() const
{
	return cdNumber;
}
 ...
 */
int CSDirTrack::getLength() const
{
	return length;
}
 ...
 */
int CSDirTrack::getBitrate() const
{
	return bitrate;
}
 ...
 */
int CSDirTrack::getSamplerate() const
{
	return samplerate;
}
 ...
 */
int64_t CSDirTrack::getSize() const
{
	return size;
}
 ...
 */
QDateTime CSDirTrack::getModifyTime() const
{
	return modifyTime;
}

/*!
 * This function serializes our track's current cached data, and returns the
 * resulting state as a byte array. Reading track data from files is rather
 * slow, so you are encouraged to serialize these track descriptors where
 * possible.
 *
 * \return Our descriptor's state, as a byte array.
 */
QByteArray CSDirTrack::serialize() const
{
	QByteArray obuf;
...
/*!
 * This function restores our track descriptor from a serialized state. Note
 * that this doesn't automatically re-read track information; you should
 * probably call refresh() manually if you expect that the source file has been
 * modified.
 *
 * \param d The byte array containing a stored track descriptor state.
 */
void CSDirTrack::unserialize(const QByteArray &d)
{
	qint32 version;
...
/*!
 * This function refreshes our cached track information by reading it again
 * from the source file. This is fairly slow, so avoid calling this function
 * unless you have a good reason to need an update.
 *
 * \return True on success, or false otherwise.
 */
bool CSDirTrack::refresh()
{
